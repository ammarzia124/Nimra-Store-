...
export default function CategoryPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen pt-48 pb-20 bg-background px-6">
      {/* Category Header */}
      <header className="relative h-[30vh] flex items-center bg-foreground/5 mb-20 overflow-hidden">
        <div className="editorial-container z-10">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-editorial font-bold italic tracking-tighter"
          >
            {category.toUpperCase()}<span className="text-accent">.</span>
          </motion.h1>
        </div>
      ...
      <main className="editorial-container">
        <div className="flex justify-between items-center mb-12 pb-6 border-b border-foreground/5">
          <p className="text-[10px] uppercase tracking-widest font-bold opacity-40">
            Showing {products.length} Engineering Results
          </p>
